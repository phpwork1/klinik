...
class CityController extends Controller {
            ...
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        ...
                        'allow' => true,
                        'roles' => [User::ROLE_TRANSPORTATION],
                    ],
                ],
            ],
            'verbs' => [
    ...
    public function actionCreate() {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', 'Data kota berhasil disimpan.');
            ...
            if (!empty($request['salin'])) {
                ...
                return $this->redirect(['index', 'CitySearch[name]' => $model->name]);
            }
        } else {
            return $this->render('create', ['model' => $model]);
        }
    ...
    public function actionDelete($id) {
        ...
        Yii::$app->session->setFlash('success', 'Data kota berhasil dihapus.');
