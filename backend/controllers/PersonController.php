    ...
    */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->transactionSave()) {
            Yii::$app->session->setFlash('success', Yii::t('app', 'Person successfully created.'));
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->transactionSave()) {
            Yii::$app->session->setFlash('success', Yii::t('app', 'Person successfully updated.'));
            return $this->redirect(['view', 'id' => $model->id]);
        } else {
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->session->setFlash('success', Yii::t('app', 'Person successfully deleted.'));
