...
insert  into `item`(`id`,`item_category_id`,`i_name`,`i_barcode`,`i_description`,`i_factory`,`i_buy_price`,`i_sell_price`,`i_ppn`,`i_retail_price`,`i_net_price`,`i_blend_price`,`i_stock_amount`,`i_unit`,`i_stock_min`,`i_stock_max`,`i_expired_date`) values (1,2,'Barang 1',NULL,'Deskripsi 1','Pabrik 1',11500,15121,1000,10000,1540,15467,100,'Tab',100,120,'2017-08-01');
...
insert  into `patient`(`id`,`p_medical_number`,`p_name`,`p_pob`,`p_dob`,`p_gender`,`religion_id`,`p_address`,`p_postal_code`,`p_contact_number`,`job_id`,`patient_id`,`p_ref`,`p_registration_date`) values (1,'P.00001','Pasien 1','Jambi','2023-02-16',0,1,'a',36142,154345,6,NULL,NULL,'2017-08-11'),(2,'P.00002','Passien 2','Jambi','2017-08-10',0,5,'Alamat 1',36142,124621,6,NULL,NULL,'2017-08-11');
