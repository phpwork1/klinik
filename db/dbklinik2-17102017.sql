...
MySQL - 5.5.5-10.1.26-MariaDB : Database - dbklinik2
*********************************************************************
*/
...
CREATE TABLE `goods_purchase` (
  ...
  `gp_invoice_number` varchar(100) NOT NULL,
  `gp_date` date NOT NULL,
  `gp_payment_method` int(1) NOT NULL,
  `gp_due_date` date NOT NULL,
  `gp_discount` int(3) NOT NULL,
  `gp_ppn` int(3) NOT NULL,
  `gp_cashier` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `gp_detail`;

CREATE TABLE `gp_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `goods_purchase_id` int(11) NOT NULL,
  `item_id` int(11) NOT NULL,
  `gpd_price` int(11) NOT NULL,
  `gpd_quantity` int(8) NOT NULL,
  `gpd_expire_date` date NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `sales` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `s_invoice_number` varchar(100) NOT NULL,
