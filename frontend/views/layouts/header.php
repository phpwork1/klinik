            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?= Yii::$app->homeUrl . '../../backend/web/uploads/people/thumb-' . $person->photo ?>" class="user-image" alt="User Image"/>
                        <span class="hidden-xs"><?= $personName ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="<?= Yii::$app->homeUrl . '../../backend/web/uploads/people/thumb-' . $person->photo ?>" class="img-circle" alt="User Image"/>
                            <p><?php
                                echo $person->name . ' - ';
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <?= Html::a(Yii::t('app', 'Profile'), ['/person/index'], ['class' => 'btn btn-default btn-flat']) ?>
                            </div>
